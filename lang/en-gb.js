...
export default {
  ...
  success: {
    ...
    utilite: {
      ...
      extraConnection: 'Extra Connection',
    },
  },
  checkout: {
    ...
    perMonth: 'per month',
    save: 'Save',
    optionalAddons: 'Optional Addons',
    ...
    proxyProtection: {
      ...
      description: {
        ...
        noPid:
          'Built-in proxy to hide the traffic to your ISP and protect your privacy',
      },
    },
    ...
    includes: {
      ...
      list: {
        1: 'Access to over 9000 TV Channels',
        2: 'Thousands of Movies & Series',
        3: 'Easy Setup on All your Devices',
        4: 'Instant Delivery',
