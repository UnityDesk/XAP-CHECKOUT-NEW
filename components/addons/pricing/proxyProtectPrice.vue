<template>
  <Pricing
    :src="require('@/assets/img/order/proxy.svg')"
    :title="data.name"
      ...
      get: function () {
        ...
        if (this.products.products[pid]) {
          if (this.products.products[pid].configoptions.configoption.length) {
            price =
              this.products.products[pid].configoptions.configoption[1].options
                .option[0].pricing[this.$t('currency.currency')]
            name =
              this.products.products[pid].configoptions.configoption[1].name
